 ...
 */
#ifndef TRACKBASE_CMFLASHCLUSTERV4_H
#define TRACKBASE_CMFLASHCLUSTERV4_H
 ...
 *
 */
class CMFlashClusterv4 : public CMFlashCluster
{
 public:
  //! ctor
  CMFlashClusterv4() = default;

  // PHObject virtual overloads
  void identify(std::ostream& os = std::cout) const override;
  void Reset() override {}
  int isValid() const override;
  PHObject* CloneMe() const override { return new CMFlashClusterv4(*this); }
  ...
  unsigned long long getParentID() const override { return m_parentID; }
  void setParentID(unsigned long long ID) override { m_parentID = ID; }

  double getPctParentID() const override { return m_pctParentID; }
  void setPctParentID(double pct) override { m_pctParentID = pct; }
 ...
 protected:
  ...
  //parent id
  unsigned long long m_parentID = ULONG_LONG_MAX;
  double m_pctParentID = NAN;

  ClassDefOverride(CMFlashClusterv4, 1)
};

#endif //TRACKBASE_CMFLASHCLUSTERV4_H
