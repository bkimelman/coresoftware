 ...
 * @author Ben Kimelman
 * @date March 2023
 * @brief Implementation of CMFlashClusterv4
 */
#include "CMFlashClusterv4.h"

#include <cmath>
#include <utility>          // for swap

void CMFlashClusterv4::identify(std::ostream& os) const
{
  os << "---CMFlashClusterv4--------------------" << std::endl;
...
int CMFlashClusterv4::isValid() const
{
...
void CMFlashClusterv4::CopyFrom( const CMFlashCluster& source )
{
