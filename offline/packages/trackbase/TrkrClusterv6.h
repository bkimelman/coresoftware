...
class TrkrClusterv6 : public TrkrCluster
{
 public:
  ...
  { std::cout << "Deprecated getz trkrcluster function!"<<std::endl; return NAN;}
   ...
   unsigned long long getParentID() const override { return m_PHG4HitID; }
   void setParentID(unsigned long long id) override { m_PHG4HitID = id; }
 ...
 protected:
  ...
  unsigned long long m_PHG4HitID;
  double m_pctParentID;
